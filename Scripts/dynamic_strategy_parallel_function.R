...
check_run_completion_fun <- function(P, 
  ...
  # Import file names of all results in the variant's estimation folder
  all_estimation_files <- list.files(paste0(results_folders[[strategy_name]][[P]][[D]][["Estimation"]][[variant]]))
